...
import net.bewis09.capyclient.mixin.client.KeyMappingAccessor
...
object KeyWidget : ScalableWidget(
    createIdentifier("capyclient", "key_widget"), "Key Widget", "Displays your movement and attack/use keys."
) {
