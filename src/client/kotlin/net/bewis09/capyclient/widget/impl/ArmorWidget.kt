...
import net.bewis09.capyclient.widget.impl.InventoryWidget.indicatorText
...
object ArmorWidget : ScalableWidget(
    createIdentifier("capyclient", "armor_widget"),
    "Armor Widget",
    ...
    val icons = mapOf(
        39 to createIdentifier("capyclient", "textures/gui/sprites/helmet.png"),
        38 to createIdentifier("capyclient", "textures/gui/sprites/chestplate.png"),
        37 to createIdentifier("capyclient", "textures/gui/sprites/leggings.png"),
        36 to createIdentifier("capyclient", "textures/gui/sprites/boots.png"),
        40 to createIdentifier("capyclient", "textures/gui/sprites/shield.png")
    )
