...
import net.bewis09.capyclient.settings.logic.Settings.gson
...
object Modrinth : ClientInterface {
...
//        SHADER("shader")
    ...
    fun getImageByURL(uri: URI): Identifier? {
        ...
        downloadFile(uri) { success ->
            ...
            val identifier = createIdentifier("capyclient", "modrinth/${uri.path.hashCode()}")
