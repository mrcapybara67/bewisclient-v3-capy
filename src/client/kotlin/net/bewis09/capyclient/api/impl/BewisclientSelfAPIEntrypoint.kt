...
class BewisclientSelfAPIEntrypoint : BewisclientAPIEntrypoint() {
    ...
    override fun getUtilities(): List<CategorizedFeature> = listOf(
        Fullbright, BlockHighlight, EntityHighlight, HeldItemTooltip, Zoom, PumpkinOverlay, BetterVisibility, Scoreboard, ShulkerBoxTooltip, Perspective, FireHeight, Panorama, TntTimer, PackAdder, AutoGG, PlayerNametag, NoChatLag, ItemPhysics, FoodSaturationOverlay
    )
