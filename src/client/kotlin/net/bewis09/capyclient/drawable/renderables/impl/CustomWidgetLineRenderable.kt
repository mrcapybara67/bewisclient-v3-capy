...
import net.bewis09.capyclient.drawable.renderables.components.structure.ScrollPlane
import net.bewis09.capyclient.drawable.renderables.popup.CustomWidgetHelpPopup
...
import net.bewis09.capyclient.drawable.screen_drawing.ScreenDrawingInterface
...
class CustomWidgetLineRenderable : Renderable() {
    ...
    override fun init() {
        ...
        lines.forEachIndexed { index, input ->
            addRenderable(ImageButton(createIdentifier("capyclient", "textures/gui/sprites/remove.png"), {
                CustomWidget.lines.removeAt(index)
                lines = computeLines()
                resize()
            }, small = true).setImagePadding(1)(x, index * 10 + y + 7, 9, 9))
            addRenderable(ImageButton(createIdentifier("capyclient", "textures/gui/sprites/up.png"), {
                if (index > 0) {
            ...
            addRenderable(ImageButton(createIdentifier("capyclient", "textures/gui/sprites/down.png"), {
        ...
        addRenderable(ImageButton(createIdentifier("capyclient", "textures/gui/sprites/help.png")) {
