...
import net.bewis09.capyclient.drawable.renderables.notification.ProgressNotification
        ...
        override fun render(screenDrawing: ScreenDrawing, mouseX: Int, mouseY: Int) {
            ...
            if (isMouseOver(mouseX, mouseY) && isMouseOver(mouseX, mouseY, centerX - 150, 49, 300, screenHeight - 49 - 33)) {
                if (screenDrawing.isMouseOver(mouseX, mouseY, x + 4, y, 32, 32)) {
                    screenDrawing.drawTexture(createIdentifier("capyclient", "textures/gui/sprites/download_highlighted.png"), x + 4, y, 32, 32)
                } else {
                    screenDrawing.drawTexture(createIdentifier("capyclient", "textures/gui/sprites/download.png"), x + 4, y, 32, 32)
                }
            }
        }
