...
import net.bewis09.capyclient.version.isKeyPressed
...
class HudEditScreen : PopupScreen(), BackgroundEffectProvider {
    ...
    val removeTexture: Identifier = createIdentifier("capyclient", "textures/gui/sprites/remove.png")
    ...
    override fun init() {
        super.init()
        addRenderable(ImageButton(createIdentifier("capyclient", "textures/gui/sprites/add.png")) {
            openPopup(AddWidgetPopup(), Color.BLACK alpha 0.625f)
        }.setImagePadding(0)(width - 16, height - 16, 14, 14))
        addRenderable(ImageButton(createIdentifier("capyclient", "textures/gui/sprites/settings.png")) {
            setRenderableScreen(OptionScreen().apply {
                changeCategory(Widgets, instant = true)
            })
