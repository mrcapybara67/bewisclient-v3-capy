...
import net.bewis09.capyclient.drawable.renderables.components.structure.EmptyRenderable
import net.bewis09.capyclient.drawable.renderables.components.structure.Plane
import net.bewis09.capyclient.drawable.renderables.components.structure.VerticalAlignPlane
...
object Home : SidebarFeature(createIdentifier("capyclient", "home"), "Capy Client") {
    ...
    object HomePlane : Renderable() {
        ...
        val checkTexture = createIdentifier("capyclient", "textures/gui/sprites/check.png")
        ...
        object BorderRadiusFader : Renderable() {
            ...
            override fun render(screenDrawing: ScreenDrawing, mouseX: Int, mouseY: Int) {
                val textWidth = screenDrawing.getTextWidth(Component.translatable("capyclient.menu.widget.border_radius"))
                screenDrawing.drawText(Component.translatable("capyclient.menu.widget.border_radius"), x, y + 3, General.getTextThemeColor())
