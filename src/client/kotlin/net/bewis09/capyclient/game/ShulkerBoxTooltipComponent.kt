...
import net.bewis09.capyclient.version.TooltipComponentCallback
...
class ShulkerBoxTooltipComponent(val data: Data) : ClientTooltipComponent {
    ...
    private fun drawSlot(x: Int, y: Int, index: Int, screenDrawing: ScreenDrawing) {
        ...
        screenDrawing.drawTexture(createIdentifier("capyclient", "textures/gui/shulker_box/slot.png"), x, y, 0f, 0f, 18, 18, 18, 18, data.color)
