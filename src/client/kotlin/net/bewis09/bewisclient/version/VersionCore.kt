...
fun ScreenDrawing.setCursorPointer() = /*[@]*/Unit/*[!@]*/
...
fun GuiGraphics.rotate(angle: Float) {
    ...
    this.pose()./*[@]*/mulPose(org.joml.Quaternionf().rotateZ(angle))/*[!@]*/
}
...
val model by lazy {
    ...
    /*[@]*/net.minecraft.client.model.PlayerModel<net.minecraft.world.entity.player.Player>/*[!@]*/(
...
fun GuiGraphics.translateToTopOptional() = /*[@]*/this.pose().translate(0f, 0f, 10000f)/*[!@]*/
...
fun createCategory(name: Identifier) = /*[@]*/"key.category.${name.namespace}.${name.path}"/*[!@]*/
...
fun registerWidget(id: Identifier, widget: (context: GuiGraphics) -> Unit) = /*[@]*/net.fabricmc.fabric.api.client.rendering.v1.HudRenderCallback.EVENT.register { context, _ -> if (!Minecraft.getInstance().options.hideGui) widget(context) }/*[!@]*/
...
fun ItemStack.appendTooltip(textConsumer: Consumer<Component>) {
    /*[@]*/this.getTooltipLines(Item.TooltipContext.EMPTY, null, TooltipFlag.NORMAL).filterIndexed { index, _ -> index != 0 }.forEach(textConsumer::accept)/*[!@]*/
}
...
fun setShaderColor(r: Float, g: Float, b: Float, a: Float) = /*[@]*/RenderSystem.setShaderColor(r, g, b, a)/*[!@]*/
