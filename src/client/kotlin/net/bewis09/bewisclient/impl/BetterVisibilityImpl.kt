...
object BetterVisibilityImpl {
    ...
    val fogModifiers = listOf(
        ...
        FogModifierConfig(BetterVisibilitySettings.nether, /*[@]*/"atmospheric"/*[!@]*/, { it * 2 - MathHelper.clamp(it / 10.0f, 4.0f, 64.0f) }, { it * 2 }),
        // @[1.21.5] "water" @[] WaterFogEnvironment::class.java
        FogModifierConfig(BetterVisibilitySettings.water, /*[@]*/"water"/*[!@]*/, { -8f }, { it }),
        // @[1.21.5] "lava" @[] LavaFogEnvironment::class.java
        FogModifierConfig(BetterVisibilitySettings.lava, /*[@]*/"lava"/*[!@]*/, { -8f }, { 16f }),
        // @[1.21.5] "powder_snow" @[] PowderedSnowFogEnvironment::class.java
        FogModifierConfig(BetterVisibilitySettings.powder_snow, /*[@]*/"powder_snow"/*[!@]*/, { -8f }, { 8f })
    )
...
/*[@]*/class FogData(var environmentalStart: Float, var environmentalEnd: Float)/*[!@]*/